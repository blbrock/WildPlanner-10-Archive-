...
# ------------------------------------------------------------------------------
#
# Change cs_path to the correct path to the Circuitscape executable (cs_run.exe)
# IMPORTANT: Do Not delete the u in front of the quoted path string.
cs_path = 'c:\\Program Files\\Circuitscape\\cs_run.exe'
